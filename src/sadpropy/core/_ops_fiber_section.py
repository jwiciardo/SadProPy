...
def _generate_rectangular_concrete_fiber_division(section_tag, materials_tag, dimensions, properties):
    ...
    ops.layer('straight', mat_rebar_tag, nBarsInt, AbarInt,   *(yStartInt, zCore),  *(yEndInt, zCore)) # Define Layer object: left reinforcements
    ops.layer('straight', mat_rebar_tag, nBarsBot, AbarBot,   *(-yCore, zCore),     *(-yCore, -zCore)) # Define Layer object: bottom reinforcements
    ops.layer('straight', mat_rebar_tag, nBarsInt, AbarInt,   *(yStartInt, -zCore), *(yEndInt, -zCore)) # Define Layer object: right reinforcements
    ...
    fiber_sec = [['section', 'Fiber', section_tag],
                ...
                ['layer', 'straight', mat_rebar_tag, nBarsInt, AbarInt, yStartInt, zCore,  yEndInt, zCore],
