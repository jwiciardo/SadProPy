...
def _plot_shell_to_elemental_loads(ax, units, coords, elements, shell_to_elemental_loads, loadcase, loadcase_type, scale, show_labels, is_arrow=True, linewidth=0.8):
    ...
    ax.add_collection3d(Poly3DCollection(
        polygon_vertices,
        facecolor="None" if is_arrow else "tab:green",
        edgecolor="tab:green",
        alpha=0.20,
